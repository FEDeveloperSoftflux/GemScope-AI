        ...
        <div className="mt-4 flex flex-col w-full">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="relative w-[180px] ml-8">
              ...
              <label className="flex items-center gap-3 cursor-pointer select-none bg-black  px-4 w-[180px] h-[45px] rounded-lg font-['Schibsted_Grotesk'] text-gray-300 hover:bg-gray-950 transition-colors">
            ...
            <div className="flex gap-2">
              ...
              <button className="px-4 py-2 rounded-lg bg-[#202020] hover:bg-[#2e2e2e] text-white/60 text-sm font-normal border border-[#333] font-[Schibsted_Grotesk] mr-10">
     ...
     <tr className="bg-black text-white text-sm">
      ...
      {filteredData.map((row, idx) => (
        <tr key={row.id} className="hover:bg-[#2a2a2a] transition text-white">
          ...
          {/* Date */}
          <td className="py-4 px-2 text-white/80 font-['Schibsted_Grotesk'] text-[14px]">
            {row.date}
          </td>
