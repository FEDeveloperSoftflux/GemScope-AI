...
const CryptoDashboard = ({ plan = "free", setUserPlan }) => {
  ...
  return (
    <div className="h-screen bg-black text-white flex flex-col md:flex-row">
      ...
      <div className="flex-1 px-0 py-6 sm:px-6 overflow-y-auto flex flex-col min-h-0 mb-4">
        <DHeader plan={plan} setUserPlan={setUserPlan} />
        <WelcomeSection />
        <ActionCards onSupportClick={() => setShowSupportModal(true)} />
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-6 md:ml-10 mt-4 flex-1 min-h-[60vh] items-stretch">
