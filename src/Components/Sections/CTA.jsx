...
const CTA = () => {
  ...
  return (
    <section className="py-20 relative overflow-hidden mr-5 ml-5 rounded-b-4xl h-[696.78px]">
      {/* Top gradient overlay for smooth blend */}
      <div className="absolute top-0 left-0 w-full h-32 z-20 pointer-events-none bg-gradient-to-b from-black/80 to-transparent"></div>
      <div
