  ...
  return (
    ...
    >
      ...
      <div className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-[80px] sm:mt-[100px] flex-1 flex flex-col transition-all duration-1000 ease-out
        ...
        <h2
          className={`mb-6 text-white font-normal text-center mx-auto font-schibsted mt-[10px]
          ...
          `}
          style={{ fontFamily: 'Schibsted Grotesk', fontWeight: '400' }}
        >
          {(() => {
        ...
        <p className="text-[15px] sm:text-lg md:text-[15px] text-white/80 mb-8 max-w-3xl mx-auto leading-relaxed tracking-[0.18px] " style={{ fontFamily: 'Lato', fontWeight: '400' }}>  
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Link to="/create-account">
            <Button size="lg">
              <span className="text-black text-[16px] " style={{ fontFamily: 'Schibsted Grotesk' }}>Register Now</span>
            </Button>
          </Link>
        </div>
      </div>
