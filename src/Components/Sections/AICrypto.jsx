...
const AICrypto = () => {
  ...
  return (
    <section className="py-20 bg-black overflow-hidden" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h2 className="mb-6 text-white font-light text-left font-['Schibsted_Grotesk'] text-[35px] sm:text-[35px] sm:leading-[36.8px] md:text-[54px] md:leading-[64.8px] md:tracking-[-2.16px] lg:text-[64px] lg:leading-[64.8x] lg:tracking-[-2.16px] max-w-[945px]">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-white/80 font-['Lato'] text-[16px] leading-[25.6px] tracking-[0px] text-justify mr-10 font-weight-400">
          ...
          >
            <img
              src={crypt}
              alt="AI Crypto"
              className="w-full h-[600px] rounded-lg shadow-lg mt-20 mb-10 "
            />
